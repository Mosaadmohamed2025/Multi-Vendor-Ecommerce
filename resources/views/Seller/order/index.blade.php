        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="{{route('SellersOrders.create')}}" class="btn btn-primary" role="button"
                    ...
                    <div class="table-responsive">
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($orders as $order)
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                <a class="dropdown-item" href="{{route('SellersOrders.edit',$order->id)}}">
                                                    <i
                                ...
                                @include('Seller.order.delete_select')
                                @include('Seller.order.delete')
                            @endforeach
                            </tbody>
                        </table>
                    </div>
