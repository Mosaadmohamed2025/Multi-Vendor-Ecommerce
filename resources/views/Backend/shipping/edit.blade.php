...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Shippings</h4><span
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Shippings.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" value="{{$shipping->shipping_address}}" required
                                           name="shipping_address" type="text" autofocus>
                                    <input class="form-control" value="{{$shipping->id}}" name="id" type="hidden">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input required class="form-control" name="delivery_time"
                                           value="{{$shipping->delivery_time}}" type="text" autofocus>
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="delivery_charge" type="number"
                                           value="{{$shipping->delivery_charge}}" autofocus>
                                </div>
                            </div>
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <select name="status" class="form-control SlectBox">
                                        ...
                                        <option {{$shipping->status == 'active' ? 'selected' : ''}} value="active">
                                            active
                                        </option>
                                        <option {{$shipping->status == 'inactive' ? 'selected' : ''}} value="inactive">
                                            inactive
                                        </option>
                                    </select>
                                </div>
