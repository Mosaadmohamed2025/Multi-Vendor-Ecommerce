...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Brand Management</h4><span
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Brands.update', 'test') }}" method="post" autocomplete="off"
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11  mg-t-5 mg-md-t-0">
                                    ...
                                    <div style="margin-top: 15px" id="output">
                                        <img src="/brand_images/{{ $brand->photo }}" style="border-radius: 50%"
