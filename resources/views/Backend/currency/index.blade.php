...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Currency Management</h4>
        ...
        <div class="col-xl-12">
            <div class="card mg-b-20">
                <div class="card-header pb-0">
                    ...
                    <a href="{{route('Currency.create')}}" class="btn btn-primary" role="button"
                       aria-pressed="true">Add Currency</a>
                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($currencies as $currency)
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="delete_select" value="{{$currency->id}}"
                                               class="delete_select">
                                    </td>
                                    <td>{{ $currency->name }}</td>
                                    ...
                                    <td>
                                        @if ($currency->status === 'active')
                                            ...
                                            <span style="margin-right: 30px">{{ $currency->status }}</span>
                                        </span>
                                        @else
                                            <span class="label text-danger d-flex"
                                                  style=" display: flex;align-items: center;justify-content: center; flex-direction: column;">
                                            <div class="dot-label bg-danger ml-1"></div>
                                            <span style="margin-right: 40px">{{ $currency->status }}</span>
                                        </span>
                                        @endif
                                    </td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu tx-13">
                                                ...
                                                <a class="dropdown-item" href="#" data-toggle="modal"
                                                   data-target="#delete{{$currency->id}}"><i
                                ...
                                @include('Backend.currency.delete_select')
