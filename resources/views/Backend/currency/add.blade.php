...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Currency Management</h4><span
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input required class="form-control" name="name" type="text" autofocus />
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input required class="form-control" name="symbol" type="text" autofocus />
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" required name="exchange_rate" type="number" step="any" autofocus />
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" required name="code" type="text" autofocus="">
                                </div>
                            </div>
