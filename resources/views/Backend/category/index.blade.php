                        ...
                        <table id="example" class="table key-buttons text-md-nowrap">
                            ...
                            @foreach($categories as $category)
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox" name="delete_select" value="{{$category->id}}"
                                               class="delete_select">
                                    </td>
                                    <td>{{ $category->title }}</td>
                                    <td><img src="/category_images/{{ $category->photo }}" style="border-radius: 50%"
                                    ...
                                    <td>
                                        @if ($category->status === 'active')
                                            ...
                                            <span style="margin-right: 30px">{{ $category->status }}</span>
                                        </span>
                                        @else
                                            <span class="label text-danger d-flex"
                                                  style=" display: flex;align-items: center;justify-content: center; flex-direction: column;">
                                            <div class="dot-label bg-danger ml-1"></div>
                                            <span style="margin-right: 40px">{{ $category->status }}</span>
                                        </span>
                                        @endif
                                    </td>
                                    <td>
                                ...
                                @include('Backend.category.delete_select')
