...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">Banners</h4><span
...
@section('content')
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('Banners.update', 'test') }}" method="post" autocomplete="off"
                        ...
                        <div class="pd-30 pd-sm-40 bg-gray-200">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="title" value="{{$banner->title}}" type="text"
                                           autofocus>
                                    <input class="form-control" value="{{$banner->id}}" name="id" type="hidden">
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                                <div class="col-md-1">
                                ...
                                <div class="col-md-11 mg-t-5 mg-md-t-0">
                                    <input class="form-control" name="description" value="{{$banner->description}}"
                                           type="text" autofocus/>
                                </div>
                            </div>
                            <div class="row row-xs align-items-center mg-b-20">
                            ...
                            <div class="row row-xs align-items-center mg-b-20">
                                ...
                                <div class="col-md-11  mg-t-5 mg-md-t-0">
                                    ...
                                    <div style="margin-top: 15px" id="output">
                                        <img src="/banner_images/{{ $banner->photo }}" style="border-radius: 50%"
