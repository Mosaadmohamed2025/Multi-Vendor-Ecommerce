                                            ...
                                            <tr>
                                                <td class="total-col">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customcheckout2" value="cod" required name="payment_method" class="custom-control-input" />
                                                        <label for="customcheckout2" class="custom-control-label">Cash On Delivery</label>
                                                    </div>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="total-col">
                                                    <div class="custom-control custom-radio">
                                                        <input type="radio" id="customcheckout3" value="stripe" required name="payment_method" class="custom-control-input" />
                                                        <label for="customcheckout3" class="custom-control-label">Visa</label>
                                                    </div>
                                                </td>
                                            </tr>
                                    </tbody>
                            ...
                            <aside class="col-lg-3">
                                <div class="summary">
                                    ...
                                    <button type="submit" class="btn btn-outline-primary-2 btn-order btn-block">
                                        ...
                                        <span class="btn-hover-text">Final Step</span>
                                    </button>
                                </div><!-- End .summary -->
                            </aside><!-- End .col-lg-3 -->
                        </div><!-- End .row -->
