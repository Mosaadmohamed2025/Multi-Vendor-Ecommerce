<head>
    ...
    <meta name="keywords" content="{{get_settings('meta_keywords')}}">
    ...
    <link rel="stylesheet" href="{{ asset('WebSite/assets/css/skins/skin-demo-6.css')}}">
    <link rel="stylesheet" href="{{ asset('WebSite/assets/css/demos/demo-6.css')}}">
